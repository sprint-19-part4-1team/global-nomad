...
>
> 본 문서는 프로젝트의 **Mandatory Rules(필수 준수 사항)**를 정의합니다.
>
> - **강제성**: 모든 코드는 이 규칙을 준수해야 하며, 위반 사항 발견 시 리뷰어는 **반드시 수정을 요청**해야 합니다.
> - **예외**: 특수한 상황으로 규칙 준수가 불가능할 경우, PR 코멘트를 통해 사유를 명시하고 팀원의 합의를 얻어야 합니다.
