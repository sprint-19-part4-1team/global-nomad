...
export default function Card({
  ...
  return (
    <Link
      href={`/${id}`}
      title={title}
      className='relative overflow-hidden rounded-18 sm:rounded-32'>
      <div className='min-h-366 rounded-18 border-1 sm:rounded-32'>
        <Image src={bannerImageUrl} fill alt={title} />
      </div>
