 ...
 * 스케줄별 예약 카운트 타입
 *
 * @property {number} pending - 신청 상태 예약 내역 수
 * @property {number} confirmed - 승인 상태 예약 내역 수
 * @property {number} declined - 거절 상태 예약 내역 수
 */
 ...
 *
 * @property {ScheduleCount} [scheduleCount] - 각 탭의 예약 내역 수
 */
 ...
 *
 * @param {ReservationTabButtonsProps} props - 컴포넌트 Props
