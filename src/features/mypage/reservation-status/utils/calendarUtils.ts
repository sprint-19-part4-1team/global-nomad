 ...
 */
export const createReservationMap = (
 ...
 */
export const calculateDateConfig = (currentMonth: Date) => {
 ...
 */
export const canNavigateToPrevMonth = (currentMonth: Date, minDate: Date): boolean => {
 ...
 */
export const canNavigateToNextMonth = (currentMonth: Date, maxDate: Date): boolean => {
