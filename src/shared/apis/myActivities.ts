...
export const getMyActivities = (params: GetMyActivitiesParams) => {
  ...
  return baseFetcher(`/my-activities?${searchParams.toString()}`, { method: 'GET' });
};
...
export const getMyActivityReservationDashboard = (
  ...
  return baseFetcher(
    `/my-activities/${activityId}/reservation-dashboard?${searchParams.toString()}`,
    { method: 'GET' }
  );
};
...
export const getMyActivityReservedSchedules = (
  ...
  return baseFetcher(`/my-activities/${activityId}/reserved-schedule?${searchParams.toString()}`, {
    method: 'GET',
  });
};
...
export const getMyActivityReservations = (
  ...
  return baseFetcher(`/my-activities/${activityId}/reservations?${searchParams.toString()}`, {
    method: 'GET',
  });
};
...
// 내 체험 수정
export const updateMyActivities = (activityId: number, data: UpdateMyActivityBodyDto) => {
