...
export type ActivitySummaryDto = Pick<
  ActivityBasicDto,
  'title' | 'price' | 'rating' | 'reviewCount' | 'bannerImageUrl'
>;
    ...
    <>
      <RoundBox className='flex w-full justify-between gap-24 bg-white px-16 py-24 shadow-card sm:px-20 sm:py-28 md:px-24 md:py-32'>
        <div className='min-w-0 flex-1'>
          ...
          <div className='mt-8 flex body-13 text-gray-500 sm:mt-4 sm:body-14 md:body-16'>
            <Icons.Star className='w-16 text-yellow-500' />
            <span className='ml-4 inline-block font-medium'>{rating}</span>
            <span className='ml-2 inline-block'>({reviewCount})</span>
          </div>
          <div className='mt-12 body-13 font-medium text-gray-400 sm:mt-8 sm:body-14 md:body-16'>
            <strong className='body-14 font-bold text-gray-950 sm:body-16 md:body-18'>
              ₩ {price}
            </strong>{' '}
            / 인
          </div>
          <div className='mt-12 flex gap-8 sm:mt-16 md:mt-20'>
            <Button size='sm' href='/mypage' variant='secondary'>
              수정하기
            </Button>
